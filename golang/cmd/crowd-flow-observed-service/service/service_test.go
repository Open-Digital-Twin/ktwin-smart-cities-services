...
func TestCrowdFlowObservedServiceSuite(t *testing.T) {

	suite.Run(t, new(CrowdFlowObservedServiceSuite))
}

type CrowdFlowObservedServiceSuite struct {
	suite.Suite
...
func (s *CrowdFlowObservedServiceSuite) SetupSuite() {
	os.Setenv("ENV", "test")
	config.LoadEnv()
...
func (s *CrowdFlowObservedServiceSuite) Test_CrowdFlowObservedEvent() {
